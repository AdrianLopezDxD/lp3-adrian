...
class ProyectoDao:
    ...
    def getProyectos(self):
        ...
        proyectoSQL = """
        SELECT id, nombre_proyecto, fecha_inicio, fecha_fin, estado
        FROM proyecto
        """
        # objeto conexion
        conexion = Conexion()
        ...
        try:
            ...
            return [{'id': proyecto[0], 'nombre_proyecto': proyecto[1], 'fecha_inicio': proyecto[2], 
        ...
        try:
            ...
            if proyectoEncontrado:
                return {
                    ...
                    "nombre_proyecto": proyectoEncontrado[1],
    ...
    def guardarProyecto(self, nombre_proyecto, fecha_inicio, fecha_fin, estado):

        insertProyectoSQL = """
        INSERT INTO proyecto(nombre_proyecto, fecha_inicio, fecha_fin, estado) 
        ...
        # Ejecucion exitosa
        try:
            cur.execute(insertProyectoSQL, (nombre_proyecto, fecha_inicio, fecha_fin, estado,))
    ...
    def updateProyecto(self, id, nombre_proyecto, fecha_inicio, fecha_fin, estado):

        updateProyectoSQL = """
        UPDATE proyecto
        SET nombre_proyecto=%s, fecha_inicio=%s, fecha_fin=%s, estado=%s
        WHERE id=%s
        """
        ...
        try:
            cur.execute(updateProyectoSQL, (nombre_proyecto, fecha_inicio, fecha_fin, estado, id,))
